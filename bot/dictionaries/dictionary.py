...
\n\n⚠️Ваш баланс автоматически пополнится после оплаты."""
    ...
    send_personal_true_text = """Личное сообщение было успешно отправлено пользователю с ID <b>{user_id}</b>."""

    send_personal_false_text = """Произошла ошибка при отправке сообщения. Попробуйте еще раз."""
    
    process_personal_text = """Введите сообщение, которое хотите отправить пользователю с ID {user_id}:"""

    user_id_error = """Ошибка. Введите корректный ID пользователя."""
...
"""
    ...
    user_id_not_found = """ID пользователя <b>{user_id}</b> не найден"""